...
import { createProblem, deleteProblem, getAllProblem, getAllProblemSolvedByUser, getProblemById, updateProblem } from "../controllers/problem.controller.js";
...
problemRoutes.get("/get-all/:id" , authMiddleware , getProblemById)
